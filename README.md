...
Objectives
Analyze Alzheimer’s disease gene expression datasets
Perform preprocessing and normalization
Construct a unified gene interaction network
Apply Graph Convolutional Neural Network (GCNN)
Identify important Alzheimer’s-related hub genes
